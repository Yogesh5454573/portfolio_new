                ...
                <div class="card-body">
                    <form class="custom-validation" method="POST" action="{{ route('admin.addUpdateProject') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="proj_stack" value="{{ old('proj_stack') }}" class="form-control"
                                id="proj_stack" placeholder="Project Stack" />
                        </div>
                        <div class="mb-6">
                            <label class="form-label" for="description">Project Description</label>
                            <textarea name="proj_desc" class="form-control" id="proj_desc" placeholder="Project Description">{{ old('proj_desc') }}</textarea>
                        </div>
                        <div class="mb-6">
