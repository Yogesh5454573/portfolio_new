        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="custom-validation" method="POST" action="{{ route('admin.addUpdateService') }}">
                            @csrf
                            <div class="mb-6">
                                <label class="form-label" for="name">Service Name <font color="red"> *</font></label>
                                <input type="text" name="ser_name" value="{{ old('ser_name') }}" class="form-control"
                                    id="ser_name" placeholder="Service Name " />
                                @error('ser_name')
                                    <span class="messages">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="ser_desc" class="form-control" id="ser_desc" placeholder="Service Description ">{{ old('ser_desc') }}</textarea>
                                @error('ser_desc')
                                    <span class="messages">
                                        <p class="text-danger error">{{ $message }}</p>
                                    </span>
                            ...
                            <div class="mb-0">
                                <div>
                                    ...
                                    <a href="{{ route('admin.serviceList') }}" class="btn btn-danger waves-effect"> Cancel </a>
                                </div>
                            </div>
                        </form>
                    </div>
